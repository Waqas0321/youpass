...
class GuaranteedPassActiveScreen extends StatefulWidget {
  const GuaranteedPassActiveScreen({super.key, required this.args});

  final GuaranteedPassActiveRouteArgs args;

  @override
  State<GuaranteedPassActiveScreen> createState() =>
      _GuaranteedPassActiveScreenState();
}

class _GuaranteedPassActiveScreenState extends State<GuaranteedPassActiveScreen> {
        ...
        child: Stack(
          children: [
            Align(
              ...
              child: AppDrawerNavigation.menuIconButton(
                context: context,
                scaffoldKey: scaffoldKey,
              ),
            ),
                ...
                children: [
                  ...
                  Text(
                    AppStrings.invitationsGpActiveMessage(
                      strings,
                      widget.args.eventTitle,
                      widget.args.cancellationDeadlineLabel ?? '—',
                    ),
                    textAlign: TextAlign.center,
                    style: TextStyle(
