...
import 'package:youpass/staff_app/features/supervisor/presentation/widgets/staff_supervisor_vip_search_result_tile.dart';

/// Reusable debounced VIP table search field with inline results dropdown.
class StaffSupervisorVipSearchField extends StatelessWidget {
  const StaffSupervisorVipSearchField({
    super.key,
  ...
  final StaffSupervisorVipSearchController controller;
  final ValueChanged<StaffSupervisorVipTableResult> onResultSelected;
  final String hint;
        ...
        final content = Column(
          ...
          children: [
            ...
            _SearchDropdown(
              ...
              noResultsLabel: l10n.staffSupervisorVipSearchNoResults,
              resultsCountLabel: (count) =>
                  l10n.staffSupervisorVipSearchResultsCount(count),
                      ...
                      Flexible(
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return StaffSupervisorVipSearchResultTile(
                              layout: layout,
                              result: result,
